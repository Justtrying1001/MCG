...
const STATS = [
  { value: formatter.format(GAME_CONFIG.GENESIS_SET.TOKEN_COUNT), label: "Tokens in Genesis" },
  { value: formatter.format(GAME_DERIVED_STATS.TOTAL_PLANNED_CARDS), label: "Cards planned" },
  { value: formatter.format(GAME_CONFIG.GENESIS_SET.PACK_COUNT), label: "Packs ready" },
  { value: "Live", label: "Contest cycle" },
] as const;
