const steps = [
  ...
  },
  {
    ...
    description: "Shape a lineup from your best pulls and get ready to compete.",
    accent: "cyan",
  ...
  },
  {
    ...
    icon: "⚔",
    title: "Compete & Win",
    description: "Enter battles, let coin performance do its work, and play for rewards.",
    accent: "yellow",
