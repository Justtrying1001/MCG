...
const RARITY_THEMES: Record<ClaudeRarityCode, RarityTheme> = {
  B: {
    ...
    label: "Common",
    accent: "#3d4a5c",
    glowCol: "rgba(61,74,92,0.05)",
    borderOut: "#181e27",
    borderIn: "#1f2733",
    wire: "rgba(255,255,255,0.07)",
    wireAcc: "rgba(255,255,255,0.1)",
    bgCard: "#11111b",
    bgHeader: "#0d0d16",
    bgFooter: "#0b0b14",
    txtName: "#c8d0dc",
  ...
  A: {
    ...
    label: "Uncommon",
    accent: "#5a7a8a",
    glowCol: "rgba(90,122,138,0.16)",
    borderOut: "#1e2d38",
    borderIn: "#253545",
    wire: "rgba(90,122,138,0.13)",
    wireAcc: "rgba(90,122,138,0.24)",
    bgCard: "#0f1318",
    bgHeader: "#0c1015",
    bgFooter: "#0a120e",
    txtName: "#d4dde6",
  ...
  S: {
    ...
    label: "Rare",
    accent: "#7090b8",
    glowCol: "rgba(112,144,184,0.28)",
    borderOut: "#243050",
    borderIn: "#2d3d60",
    wire: "rgba(112,144,184,0.16)",
    wireAcc: "rgba(112,144,184,0.29)",
    bgCard: "#0d1220",
    bgHeader: "#0a0f1a",
    bgFooter: "#090d16",
    txtName: "#dce6f4",
  ...
  "S+": {
    ...
    label: "Legendary",
    accent: "#b89a60",
    glowCol: "rgba(184,154,96,0.43)",
    borderOut: "#3a2e18",
    borderIn: "#4a3c22",
    wire: "rgba(184,154,96,0.16)",
    wireAcc: "rgba(184,154,96,0.33)",
    bgCard: "#0e0b04",
    bgHeader: "#0b0802",
    bgFooter: "#090703",
    txtName: "#ece0c8",
